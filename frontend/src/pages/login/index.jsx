...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white font-sans">
      {/* Left Side - Form */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-12 lg:px-24 xl:px-32 py-12">
        {/* Logo */}
        <div className="flex items-center gap-2 mb-12">
          <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
            <Icon name="Plane" className="text-blue-600 w-5 h-5" />
          </div>
        ...
        {/* Google Button */}
        <button
          className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-lg p-3 text-gray-700 font-medium hover:bg-gray-50 transition-colors mb-6"
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute bottom-12 left-12 right-12 text-white">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">Craft your perfect journey.</h2>
          <p className="text-lg text-white/90 mb-8 max-w-lg">
            Discover new places, plan multi-city trips, and create memories that last a lifetime with our personalized travel tools.
          </p>
